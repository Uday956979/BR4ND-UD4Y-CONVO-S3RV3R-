    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] TRICK3R W4NT3D BR4ND {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " TRICK3R W4NT3D BR4ND TOOL ")
    print(Fore.CYAN + "------------------------------------")
